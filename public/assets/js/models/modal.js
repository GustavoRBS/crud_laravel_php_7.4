var Modal = new Class({
    ...
    create: function () {
        ...
        var div ='<div id="' + this.id + '" class="modal-basic modal fade modal-ajax show" data-keyboard="false" aria-hidden="true" tabindex="-1" role="dialog" data-backdrop="true">';        
        div += '	<div class="modal-dialog modal-md" role="document">';
        div += '		<div class="modal-content modal-bg-white ">';
        div += "		</div>";
        div += "	</div>";
        div += "</div>";
